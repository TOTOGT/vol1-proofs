...
-- ══════════════════════════════════════════════════════════════════════════
--  SELF-CHECK.  Everything below is the verifier, not the mathematics.
--
--      cd ~/Desktop/AXLE
--      lake env lean ~/Desktop/vol1-proofs/AutophagyMerged_selfcheck.lean
--
--  Three questions, in order:
--    1. does every proof establish its stated proposition   (#print axioms)
--    2. does every proposition assert something             (#vacuity_scan)
--    3. does every Prop-definition mention its own subject  (#unused_param_scan)
--
--  The kernel answers only the first. The second was added after three
--  `True := trivial` theorems passed it. The third was added after
--  IsMorseCritical -- which does assert something, and asserted it of a
--  variable it never mentioned -- passed both.
-- ══════════════════════════════════════════════════════════════════════════
